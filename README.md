...
- **Pricing grid** — Gemini, OpenAI, Anthropic, Mistral (input/output/cached per 1M tokens). Each card may show a note on tiered or context-based pricing and a link to official pricing. **Retired** badge marks deprecated models (Gemini 1.0, older GPT-4/3.5, Claude 3.x, legacy Mistral).
