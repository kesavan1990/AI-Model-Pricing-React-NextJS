/**
 * Shared data pipeline: official overlays + reassign provider + provider/bucket filter + retired filter.
...
/** Run reassign → isAllowedModel (bucket + canonical) → retired. Returns cleaned payload. */
